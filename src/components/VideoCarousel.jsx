  ...
  return (
    ...
    >
            ...
            <div id='slider' className='sm:pr-20 pr-10' key={list.id}>
               <div className='relative sm:w-[70vw] w-[88vw] md:h-[70vh] sm:h-[50vh] h-[35vh]'>
                <div className='w-full h-full flex justify-center items-center rounded-3xl overflow-hidden bg-black'>
                    ...
                    ref={(el)=>(videoRef.current[i]=el)} id='video' playsInline={true} preload='auto'
                    muted
                ...
                <div className='absolute top-12 left-[5%] z-10'>
                    {list.textLists.map((text)=>(
                        <p className='md:text-xl text-xl font-medium' key={text}>
                            {text}
                        </p>
                    ))}
                </div>
        ...
        <div className='relative flex justify-center items-center mt-10'>
            <div className='py-5 px-7 flex justify-center items-center bg-gray-900 backdrop-blur rounded-full'>
              ...
              className='ml-4 p-4 rounded-full bg-gray-700 backdrop-blur flex justify-center items-center  '>
